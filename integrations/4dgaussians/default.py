"""Default 4DGS settings, resolved from the best-tested quality3 experiment.

Use scripts/train_4dgs.py to override iteration counts and batch size.
"""
...
OptimizationParams = dict(
    ...
    # Keep the tested reset interval beyond the default training schedule.
